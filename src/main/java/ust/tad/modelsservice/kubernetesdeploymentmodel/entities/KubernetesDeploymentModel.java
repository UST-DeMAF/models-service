package ust.tad.modelsservice.kubernetesdeploymentmodel.entities;

import org.springframework.data.annotation.Id;
import org.springframework.data.mongodb.core.mapping.Document;
import ust.tad.modelsservice.kubernetesdeploymentmodel.entities.configStorageResources.ConfigMap;
import ust.tad.modelsservice.kubernetesdeploymentmodel.entities.configStorageResources.PersistentVolumeClaim;
import ust.tad.modelsservice.kubernetesdeploymentmodel.entities.ingress.KubernetesIngress;
import ust.tad.modelsservice.kubernetesdeploymentmodel.entities.service.KubernetesService;
import ust.tad.modelsservice.kubernetesdeploymentmodel.entities.workload.deployment.KubernetesDeployment;
import ust.tad.modelsservice.kubernetesdeploymentmodel.entities.workload.pods.KubernetesPodSpec;
...
@Document(collection = "kubernetesdeploymentmodels")
public class KubernetesDeploymentModel {
  ...
  public KubernetesDeploymentModel addFromOtherModel(KubernetesDeploymentModel  otherModel) {
